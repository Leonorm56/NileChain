import * as _$zlib from "zlib";
import * as fs from "fs";

//#region lib/core/types.d.ts
type COMPRESSION_LEVELS = 'uncompressed' | 'medium' | 'high';
type TAR_COMPRESSION_TYPE = 'none' | 'gzip' | 'brotli';
type CoreOptions = {
...
type TarArchiveOptions = CoreOptions & {
  gzip?: boolean;
  gzipOptions?: _$zlib.ZlibOptions;
  compressionType?: TAR_COMPRESSION_TYPE;
  brotliOptions?: _$zlib.BrotliOptions;
  customWriteStream?: fs.WriteStream;
  compression?: COMPRESSION_LEVELS;
};
type SevenZipArchiveOptions = CoreOptions & {
...
declare const COMPRESSION_LEVEL: {
...
declare class ZipAFolder {
  ...
  static sevenZip(source: string, targetFilePath?: string, options?: SevenZipArchiveOptions): Promise<void>;
}
...
declare function sevenZip(source: string, targetFilePath?: string, options?: SevenZipArchiveOptions): Promise<void>;
//#endregion
export { COMPRESSION_LEVEL, type SevenZipArchiveOptions, type TAR_COMPRESSION_TYPE, type TarArchiveOptions, ZipAFolder, type ZipArchiveOptions, sevenZip, tar, zip };