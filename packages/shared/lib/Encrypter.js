...
export default class Encrypter {
  ...
  static async scryptPass(password, saltB64) {
  ...
  static async encryptData({ data, password, salt, nonce, encode = true }) {
  ...
  static async decryptData({ encrypted, password, salt, asText = true }) {
    const bundle =
